...
const SETTINGS: SettingMeta[] = [
  ...
  { id: 'invertControls', labelKey: 'setting_invertControls', category: 'controls', type: 'toggle', implemented: true, description: 'Invert left/right controls' },
  { id: 'showFPS', labelKey: 'setting_showFPS', category: 'gameplay', type: 'toggle', implemented: true, description: 'Show FPS counter in top corner' },
  ...
  { id: 'colorBlindMode', labelKey: 'setting_colorBlindMode', category: 'accessibility', type: 'select', implemented: true, options: ['none','protanopia','deuteranopia'], description: 'Color-blind accessibility mode' },
